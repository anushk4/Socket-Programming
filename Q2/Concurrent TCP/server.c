...
int main() {
    ...
    // Loop for accept and handle incoming client connections that is to etablish a multithreaded connection.
    while (1) {
        ...
        *client_sock = new_sock;
        ...
        pthread_create(&client_thread, NULL, handle_client_for_connection, client_sock);
